...
import { PCdessertsChildContentCompanent } from "./PCdessertsChildContentCompanent"
import { PCdessertDescriptionWindowComponent } from "./PCdessertDescriptionWindowComponent"




export const PCdessertsContantCompanent = () => {
    ...
    return <div id="PCglobalDessertsContantCompanent">
        ...
        <a href='https://drive.google.com/file/d/16FQv36RAv4TbQ1E6tgC8RXm_Wp1kri97/view?usp=sharing'
            ...
            className="PCcontactChildComponent">
            скачать</a>

        <div id="PCdessertsContantCompanent">
            {showDescriptionDessertWindow()}
            {
                assortimentDesertsArr.map(elem => {

                    return <PCdessertsChildContentCompanent
                        name={elem.name}
                        img={elem.img}
                        button={elem.button}
                        key={nanoid()}
